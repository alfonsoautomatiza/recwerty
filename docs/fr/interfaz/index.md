...
L'interface de RecWERTY adopte un design sombre style "Nothing" avec des accents rouges (#D71921).

Elle comprend un panneau de navigation latéral et une barre d'état supérieure.
