...
!!! info "Flujo de trabajo típico"
    1. Configurás tu captura y efectos
    2. Grabás tu pantalla
    3. Revisás la vista previa
    4. Aplicás ajustes finales
    5. Exportás a video o GIF

## ¿Para quién es RecWERTY?

RecWERTY está pensado para creadores de contenido técnico, desarrolladores que necesitan grabar demos rápidas, equipos de soporte que crean tutoriales, y cualquier persona que quiera producir videos profesionales sin pasar por un editor de video tradicional.
