...
!!! info "Atajos durante la grabación"
    Los atajos se muestran en la interfaz durante la grabación. Podés consultar la lista completa en [Atajos de teclado](../atajos.md).
